...
function setActions(primary?: Action, secondary?: Action) {
    if (primary) {
        ...
        primaryBtn.onclick = primary.onClick;
        primaryBtn.classList.add("visible");
    } else {
        primaryBtn.onclick = null;
        primaryBtn.classList.remove("visible");
    }
    if (secondary) {
        secondaryBtn.textContent = secondary.label;
        secondaryBtn.onclick = secondary.onClick;
        secondaryBtn.classList.add("visible");
    } else {
        secondaryBtn.onclick = null;
        secondaryBtn.classList.remove("visible");
    }
}
...
function promptInstall() {
    render({
        icon: "warn",
        title: "Brick isn't installed",
        message: "The Brick CLI wasn't found on this computer. Would you like to install it now?",
    });
    setActions(
        { label: "Install", onClick: () => void doInstall() },
        {
            label: "Not now",
            onClick: () => {
                render({
